...
jei įrankis yra {IMAGE_GENERATION}, atsakyk su JSON objektu, kuris aprašo įrankio kvietimą. JSON turi \
įtraukti "prompt" lauką su tekstu, kuris turi būti renduojamas. Kai naudotojas nurodo ar implikuoja orientaciją, \
įtraukite "shape" lauką, kurio reikšmė yra viena iš "square", "landscape", ar "portrait" (naudok "landscape" \
ir "portrait" atitinkamai). Pavyzdys: {"prompt": "Sukurk posterį apie koralinių rifų rajoną", "shape": "landscape"}. \
Do not surround the JSON with backticks or narration.
""",
}
