...
Cituokite atitinkamas ištraukas EILUTĖJE, naudodami formatą [[1]](https://example.com) 
su dokumento numeriu (sveikuoju skaičiumi) tarp skliaustų. Norėdami cituoti kelis dokumentus, 
naudokite [[1]](https://example.com), [[2]](https://example.com) formatą, o ne [[1, 2]](https://example.com). 
Pabandykite cituoti tekste, o ne tik gale.
""".rstrip()
